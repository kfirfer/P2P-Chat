...
public class AccountDAO {
    ...
    public AccountDAO(GuiController controller) {
        ...
        conn = ConnectionManager.getInstance().getConnection(controller);
    }
     ...
     * Add new friend
     *
     * @param user   the user name who want add friend
     ...
     * Remove friend
     *
     * @param user   the username who have this friend
     * @param friend the friend who will be removed
     ...
     *
     * @param user   the user who will get request
     * @param friend who sent the request
     ...
     * Add client.block
     *
     * @param user  the user who want client.block
     * @param block the client.block username
     ...
     * Remove client.block
     *
     * @param user  the user who want remove client.block
     * @param block the client.block to be removed
    ...
    public Set<String> getSearchList(String name) {

        Set<String> list = new HashSet<>();

        String query = "SELECT * FROM accounts WHERE user LIKE '" + name + "%' LIMIT 0,30";
